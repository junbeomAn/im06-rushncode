  ...
  <div className="no-result-container">
    <div className="emptybox">
      <h1 className="no-result-text">
        <span className="no-result-keyword">&rsquo;{ decodeURI(window.location.href).split('?q=')[1] || decodeURI(window.location.href).split('tag/')[1]}&rsquo;</span>&nbsp;<br />에 대한 검색 결과가 없습니다.
      </h1>
    </div>
